...
const MOCK_DATA: Invoice[] = [
  {
    ...
    dueDate: "2026-04-05",
    irr: "12.4%",
    contractAddr: "0x71C...a291",
    riskMetrics: [
      { label: "Financials", score: 92 },
      { label: "History", score: 88 },
      { label: "Outlook", score: 75 },
    ],
  },
  {
    id: "2",
    ...
    dueDate: "2026-06-01",
    irr: "15.1%",
    contractAddr: "0x32A...f842",
    riskMetrics: [
      { label: "Financials", score: 70 },
      { label: "History", score: 65 },
      { label: "Outlook", score: 82 },
    ],
  },
  {
    id: "3",
    ...
    dueDate: "2026-03-20",
    irr: "9.8%",
    contractAddr: "0x99B...e110",
    riskMetrics: [
      { label: "Financials", score: 96 },
      { label: "History", score: 98 },
      { label: "Outlook", score: 90 },
    ],
  },
  {
    id: "4",
    ...
    dueDate: "2026-08-12",
    irr: "13.2%",
    contractAddr: "0x44D...c221",
    riskMetrics: [
      { label: "Financials", score: 85 },
      { label: "History", score: 90 },
      { label: "Outlook", score: 92 },
    ],
  },
  {
    id: "5",
    ...
    dueDate: "2026-05-30",
    irr: "11.5%",
    contractAddr: "0x88F...a332",
    riskMetrics: [
      { label: "Financials", score: 60 },
      { label: "History", score: 72 },
      { label: "Outlook", score: 70 },
    ],
  },
  {
    id: "6",
    client: "Nordic Shipping",
    sector: "Maritime",
    amount: 45000,
    risk: 91,
    type: "fractional",
    ...
    dueDate: "2026-04-15",
    irr: "10.1%",
    contractAddr: "0x11E...b998",
    riskMetrics: [
      { label: "Financials", score: 94 },
      { label: "History", score: 95 },
      { label: "Outlook", score: 85 },
    ],
  },
  {
    id: "7",
    client: "Swift Automotives",
    ...
    dueDate: "2026-09-20",
    irr: "14.8%",
    contractAddr: "0x55G...d443",
    riskMetrics: [
      { label: "Financials", score: 75 },
      { label: "History", score: 80 },
      { label: "Outlook", score: 78 },
    ],
  },
  {
    id: "8",
    ...
    dueDate: "2026-03-25",
    irr: "16.5%",
    contractAddr: "0x22H...e554",
    riskMetrics: [
      { label: "Financials", score: 55 },
      { label: "History", score: 60 },
      { label: "Outlook", score: 70 },
    ],
  },
];
    ...
    return MOCK_DATA.filter((inv) => {
      ...
      const matchesDue =
        dueFilter === "all"
          ? true
          : dueFilter === "30"
            ? new Date(inv.dueDate) <= new Date("2026-04-11")
            : true;
      ...
      <main className="max-w-[1400px] mx-auto p-6 md:p-12">
        ...
        <header className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <span className="bg-blue-600 text-white px-3 py-1 rounded-lg text-xs font-black tracking-tighter uppercase italic">
                InvoiceChain
              </span>
          ...
          <button
            ...
            className="relative p-5 bg-white border border-slate-200 rounded-[2rem] shadow-xl hover:shadow-2xl transition-all"
          >
            <ShoppingCart size={24} className="text-slate-800" />
            {cart.length > 0 && (
              <span className="absolute -top-1 -right-1 bg-blue-600 text-white text-[10px] font-black px-2 py-1 rounded-full border-2 border-[#F8FAFC]">
                {cart.length}
              </span>
            )}
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12 bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm">
          ...
          <div className="flex items-center gap-3 bg-slate-50 px-4 py-3 rounded-2xl">
            ...
            <select
              className="bg-transparent w-full text-xs font-black uppercase outline-none cursor-pointer"
              value={riskFilter}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredData.map((inv) => (
            <div
              ...
              className="group bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all cursor-pointer flex flex-col justify-between"
            >
              <div>
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div
                    className={`px-2 py-1 rounded-md text-[9px] font-black uppercase ${inv.risk >= 85 ? "text-emerald-600 bg-emerald-50" : "text-amber-600 bg-amber-50"}`}
                  >
                    Risk: {inv.risk}
                  </div>
                </div>
                ...
                <p className="text-slate-400 text-xs font-bold flex items-center gap-1.5 mb-8">
                  <Clock size={14} /> {inv.dueDate}
                </p>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-xl bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-500">
            <div className="p-10 border-b flex justify-between items-center bg-slate-50/50">
              ...
              <button
                onClick={() => setViewingDetails(null)}
                className="p-3 hover:bg-white rounded-full transition shadow-sm"
              >
                <X />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-12 space-y-12">
              <section className="bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl">
                ...
                <div className="bg-white/10 p-4 rounded-xl font-mono text-xs text-slate-300 mb-6 truncate">
              ...
              <section>
                <h5 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-10">
                  Risk Profile Analytics
                </h5>
                <div className="space-y-8">
                  {viewingDetails.riskMetrics.map((metric, idx) => (
                    <div key={idx}>
                      <div className="flex justify-between mb-3 text-sm font-black text-slate-700">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/60 backdrop-blur-xl p-4">
          <div className="bg-white w-full max-w-md rounded-[3rem] p-12 shadow-2xl relative">
            <button
              ...
              className="absolute right-8 top-8 p-2 hover:bg-slate-100 rounded-full transition"
            >
              <X />
            </button>
            ...
            <p className="text-slate-400 mb-10 uppercase text-[10px] font-black tracking-[0.2em]">
              {selectedInv.type} order placement
            </p>
            ...
            {selectedInv.type === "fractional" && (
              <div className="mb-10 flex items-center justify-between bg-slate-50 p-6 rounded-2xl">
                <button
                  className="w-14 h-14 bg-white rounded-xl shadow-md font-black text-2xl"
                  onClick={() =>
            ...
            <div className="flex-1 overflow-y-auto p-10 space-y-6">
              {cart.length === 0 ? (
                ...
                cart.map((item, idx) => (
                  <div
                    key={idx}
                    className="p-8 bg-[#F8FAFC] rounded-[2.5rem] border border-slate-100 relative group"
                  >
                    <button
                      onClick={() => removeFromCart(item.id)}
                      className="absolute -top-2 -right-2 bg-white text-rose-500 p-2.5 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
                    >
                      <Trash2 size={16} />
                    </button>
                    ...
                    <div className="flex justify-between items-center">
                      <p className="text-slate-500 text-xs font-black uppercase tracking-widest">
                        {item.shares ? `${item.shares} Shares` : "Full Asset"}
                      </p>
            ...
            {cart.length > 0 && (
              <div className="p-12 border-t bg-[#F8FAFC] rounded-t-[3.5rem]">
                <div className="flex justify-between items-center mb-10">
                  <span className="font-black text-slate-400 uppercase text-xs tracking-widest">
                    Total Batch Value
                  </span>
                  <span className="text-4xl font-black text-slate-900">
                ...
                {purchaseStep === "idle" && (
                  <button
                    ...
                    className="w-full py-7 bg-slate-900 text-white rounded-[2rem] font-black text-2xl"
                  >
                    Execute Checkout
                  </button>
                )}
                {purchaseStep === "processing" && (
                  <div className="text-center py-4">
                    <Loader2
                      ...
                      size={40}
                    />
                    <p className="font-black text-slate-800 text-xs mt-4 uppercase">
                      Verifying on Polygon...
                    </p>
                  </div>
                )}
                {purchaseStep === "success" && (
                  <div className="text-center bg-emerald-50 p-10 rounded-[3rem]">
                    <CheckCircle2
                      className="text-emerald-500 mx-auto mb-4"
                      size={50}
                    />
                    <p className="font-black text-emerald-900 text-xl uppercase">
                      Investment Minted
                    </p>
                  </div>
                )}
