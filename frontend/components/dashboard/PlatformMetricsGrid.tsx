...
export function PlatformMetricsGrid({
  ...
  const metricsList = [
    ...
    },
    {
      ...
      value: formatPercent(metrics.repayment_rate),
    ...
    },
    {
      ...
      value: metrics.active_sellers.toString(),
      color: "bg-blue-50 border-blue-200",
    },
    {
      title: "Active Investors",
      value: metrics.active_investors.toString(),
      color: "bg-green-50 border-green-200",
    },
    {
    ...
    },
    {
      ...
      value: metrics.high_risk_invoices.toString(),
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {metricsList.map((metric, idx) => (
        <div
          key={idx}
          className={`${metric.color} border rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow`}
        >
